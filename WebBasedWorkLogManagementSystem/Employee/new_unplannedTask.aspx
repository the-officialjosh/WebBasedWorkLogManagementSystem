<%@ Page Title="New Unplanned Task | Employee Panel | Web-Based Worklog Management System" Language="vb" AutoEventWireup="false" MasterPageFile="~/Employee/Employee.Master" CodeBehind="new_unplannedTask.aspx.vb" Inherits="WebBasedWorkLogManagementSystem.new_unplannedTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">New Unplanned Task</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                  Use the form below to create your new unplanned Task
                                 </div>
