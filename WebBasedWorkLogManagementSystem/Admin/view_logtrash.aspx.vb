...
Public Class view_logtrash
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs)
        If e.CommandName = "reverseLog" Then
            ...
            With sqlds
                ...
                .UpdateParameters.Add("work_delete", 0)
        ...
        If e.CommandName = "deleteLog" Then
            ...
            With sqlds
                ...
                .DeleteCommand = "DELETE FROM tblWork WHERE work_id=@work_id"
                .DeleteParameters.Add("work_id", workId)
            End With
            Dim rmvlog As Integer
            rmvlog = sqlds.Delete
            GridView1.DataBind()
